      ...
      {!isMobile && (
        <footer className="footer">
            ...
            <div className="partners  text-center">
              <div className="partners-logos">
                ...
                <p className="mt-2 text-start">
                  500AE - nền tảng giải trí chuyên nghiệp chất lượng cao, đạt
                  chỉ tiêu kiểm định và được cấp phép bởi chính phủ Philippines.
                  Nổi bật với kho trò chơi đa dạng, khuyến mãi hấp dẫn, thanh
                  toán siêu tốc, hỗ trợ thành viên tận tâm, chuyên nghiệp...
                </p>
              </div>
            </div>
          ...
          <div className="footer-links">
            <a href="#">VỀ CHÚNG TÔI</a> |<a href="#">ĐIỀU KHOẢN DỊCH VỤ</a> |
            <a href="#">CHÍNH SÁCH BẢO MẬT</a> |<a href="#">LIÊN HỆ</a> |
            <a href="#">BẢN QUYỀN</a> |<a href="#">MIỄN TRỪ TRÁCH NHIỆM</a>
          </div>
        </footer>
      )}
